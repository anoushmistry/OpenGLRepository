...
//		glm::vec3(4.8f, -1.0f, -7.3f),
//		glm::vec3(1.9f, -1.5f, -2.5f),
//		glm::vec3(8.5f,  3.0f, -2.5f),
//		glm::vec3(-3.5f,  6.2f, -1.5f),
...
//
//		data = stbi_load("LeonSKeneddy.png", &width, &height, &clrChannels, STBI_rgb_alpha);
//		if (data)
//		{
...
//		stbi_set_flip_vertically_on_load(true);
//
//		data = stbi_load("AdaWong.png", &width, &height, &clrChannels, STBI_rgb_alpha);
//		if (data)
//		{
//			glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
//			glGenerateMipmap(GL_TEXTURE_2D);
